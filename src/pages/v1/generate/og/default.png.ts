...
export const GET: APIRoute = async () => {
  const link = 'https://atharva.types.vercel.app';
    ...
    <div style="display:flex; height: 100%; width: 100%; background-color: white; border: 6px solid black; border-radius: 0.5rem; padding: 2rem; filter: drop-shadow(6px 6px 0 rgb(0 0 0 / 1));">
      <div style="display: flex; flex-direction: column; justify-content: space-between; width: 100%; filter: drop-shadow()">
        <div style="display: flex; flex-direction: column; gap: 0.75rem;">  
          ...
          <p style="font-size: 28px;">Web & Content Team @DevsInTech</p>
          <p style="font-size: 28px;">Support Patrol @AstroLounge Discord</p>
          <p style="font-size: 28px;">Frontend Enthusiast, Documentation Fanatic</p>
          <p style="font-size: 28px;">Prev. Infineon Technologies</p>
        </div>
